...
class PostApiTest(APITestCase):
  ...
  def test_update_post(self):
    ...
    data = {
        "title": "Newsletter : c’est quoi ? Guide, définition et exemples 2021",
        "author": 1,
        "excerpt": "Newsletter : c’est quoi ? Guide, définition et exemples 2021",
        "content": "Newsletter : c’est quoi ? Guide, définition et exemples 2021",
        "status": "published"
    }
